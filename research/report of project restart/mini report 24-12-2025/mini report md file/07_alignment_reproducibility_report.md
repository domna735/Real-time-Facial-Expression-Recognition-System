...
## Feb 2026 addendum (suite-level reproducibility)

To make comparisons across many datasets reproducible and audit-friendly, the project added an offline benchmark suite runner that exports a single index + CSV:
...
These artifacts are referenced directly in the final report addendum:

- `research/final report/final report.md` → **9.3.5**
