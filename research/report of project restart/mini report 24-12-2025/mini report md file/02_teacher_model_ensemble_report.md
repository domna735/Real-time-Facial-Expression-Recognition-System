...
For later evidence-backed offline suite exports, dataset diagnostics, and paper-style comparisons, see:
...
## Feb 2026 addendum (offline suite + paper comparison pointers)

For a more paper-style comparison, the project later ran an ordered offline benchmark suite and exported a single CSV for all model×dataset results:

- `outputs/benchmarks/offline_suite__20260208_192604/benchmark_results.csv`

This suite is also used by the final report’s “paper comparison” addendum:

- `research/final report/final report.md` → Section **9.3.6**
